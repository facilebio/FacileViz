...
#'              hover = c("class", "c"),
#'              facet_aes = "class", shareX = TRUE, shareY = TRUE)
#' fscatterplot(dat, c("a", "b"), color_aes = "class", shape_aes = "grp",
#'              hover = c("class", "c"),
#'              facet_aes = "grp", shareX = TRUE, shareY = TRUE)
#' # 3d
#' fscatterplot(dat, c("a", "b", "c"), color_aes = "class",
#'              hover = c("class", "c"))
#' fscatterplot(dat, c("a", "b", "c"), color_aes = "class",
#'              hover = c("class", "c"), facet_aes = "class")
...
fscatterplot.data.frame <- function(dat, axes,
  ...
  plot <- maybe_facet_wrap(.fscatterplot, xx, facet_aes, facet_nrows,
...
#' Generates the final plotly plot, which will be decorate with class
